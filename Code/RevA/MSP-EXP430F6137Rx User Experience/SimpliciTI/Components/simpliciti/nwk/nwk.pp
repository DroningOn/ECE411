#line 1 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk.c"
...
#line 40 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk.c"
...
#line 41 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk.c"
...
#line 42 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk.c"
...
#line 43 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk.c"
#line 1 "C:\\ti\\msp430\\MSP-EXPCC430_UE_1_00_00_01\\src\\MSP-EXP430F6137Rx_User_Experience\\SimpliciTI\\Components\\simpliciti\\nwk\\nwk_frame.h"
...
#line 44 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk.c"
#line 1 "C:\\ti\\msp430\\MSP-EXPCC430_UE_1_00_00_01\\src\\MSP-EXP430F6137Rx_User_Experience\\SimpliciTI\\Components\\simpliciti\\nwk\\nwk.h"
...
#line 45 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk.c"
#line 1 "C:\\ti\\msp430\\MSP-EXPCC430_UE_1_00_00_01\\src\\MSP-EXP430F6137Rx_User_Experience\\SimpliciTI\\Components\\simpliciti\\nwk\\nwk_app.h"
...
#line 46 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk.c"
#line 1 "C:\\ti\\msp430\\MSP-EXPCC430_UE_1_00_00_01\\src\\MSP-EXP430F6137Rx_User_Experience\\SimpliciTI\\Components\\simpliciti\\nwk\\nwk_globals.h"
...
#line 47 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk.c"
#line 1 "C:\\ti\\msp430\\MSP-EXPCC430_UE_1_00_00_01\\src\\MSP-EXP430F6137Rx_User_Experience\\SimpliciTI\\Components\\simpliciti\\nwk\\nwk_QMgmt.h"
...
#line 48 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk.c"
...
static persistentContext_t sPersistInfo = {1};
...
smplStatus_t nwk_nwkInit(uint8_t (*f)(linkID_t))
{
  ...
  sPersistInfo.numConnections   = (8+1);
  sPersistInfo.curNextLinkPort  = (0x3E - 1);
  sPersistInfo.curMaxReplyPort  = 0x20;
  ...
  if ((0x00) == sPersistInfo.connStruct[8].connState)
  {
    sPersistInfo.connStruct[8].connState   = (0x02);
    sPersistInfo.connStruct[8].hops2target = 3;
    sPersistInfo.connStruct[8].portRx      = 0x3F;
    sPersistInfo.connStruct[8].portTx      = 0x3F;
    sPersistInfo.connStruct[8].thisLinkID  = ((linkID_t) ~0);
     
    memcpy(sPersistInfo.connStruct[8].peerAddr, nwk_getBCastAddress(), 4);
  }
...
static void initializeConnection(connInfo_t *pCInfo)
{
  ...
  while (!*locLID || (*locLID == ((linkID_t) ~0)) || map_lid2idx(*locLID, &tmp))
  {
    (*locLID)++;
  }
...
connInfo_t *nwk_getConnInfo(linkID_t linkID)
{
  ...
  return (rc && ((0x02) == sPersistInfo.connStruct[idx].connState)) ? &sPersistInfo.connStruct[idx] : (connInfo_t *)0;
}
...
connInfo_t *nwk_isLinkDuplicate(uint8_t *addr, uint8_t remotePort)
{
  ...
  for (i=0; i<8; ++i,++ptr)
  {
    if ((0x02) == ptr->connState)
    {
      if (!(memcmp(ptr->peerAddr, addr, 4)) &&
...
uint8_t nwk_findAddressMatch(mrfiPacket_t *frame)
{
  ...
  for (i=0; i<8; ++i,++ptr)
  {
    ...
    if ((0x02) == ptr->connState)
    {
      if (!(memcmp(ptr->peerAddr, (&((frame)->frame[((0 + 1) + 4)])), 4)))
      {
        return 1;
      }
    }
...
uint8_t nwk_saveJoinedDevice(mrfiPacket_t *frame)
{
  ...
  for (i=0; i<8; ++i, ++ptr)
  {
    if ((ptr->connState == (0x02)) || (ptr->connState == (0x01)))
    {
      if (!memcmp(ptr->peerAddr, (&((frame)->frame[((0 + 1) + 4)])), 4))
      {
        return 0;
  ...
  avail->connState = (0x01);
  memcpy(avail->peerAddr, (&((frame)->frame[((0 + 1) + 4)])), 4);
...
smplStatus_t nwk_checkConnInfo(connInfo_t *ptr, uint8_t which)
{
  ...
  port = (0 == which) ? ptr->portRx : ptr->portTx;
  if (!port || ((0x00) == ptr->connState))
  {
...
uint8_t nwk_isConnectionValid(mrfiPacket_t *frame, linkID_t *lid)
{
  uint8_t       i;
  connInfo_t   *ptr  = sPersistInfo.connStruct;
  uint8_t       port = (((&((frame)->frame[(((0 + 1) + 4) + 4)])))[0] & ((0x3F)));
  ...
  for (i=0; i<(8+1); ++i,++ptr)
  {
    if ((0x02) == ptr->connState)
    {
      ...
      if (port == ptr->portRx)
      {
        ...
        if ((0x3F == port) || !(memcmp(ptr->peerAddr, (&((frame)->frame[((0 + 1) + 4)])), 4)))
        {
          uint8_t rc = 1;
          ...
          *lid = ptr->thisLinkID;
          ...
          if (!(0x3F == port))
          {
            if ((((&((frame)->frame[(((0 + 1) + 4) + 4)])))[1] & ((0x80))))
            {
               
              nwk_sendAckReply(frame, ptr->portTx);
            }
            else if ((((&((frame)->frame[(((0 + 1) + 4) + 4)])))[1] & ((0x08))))
            {
              ...
              if (ptr->ackTID == (((&((frame)->frame[(((0 + 1) + 4) + 4)])))[2] & ((0xFF))))
              {
                ptr->ackTID = 0;
              }
...
uint8_t nwk_allocateLocalRxPort(uint8_t which, connInfo_t *newPtr)
{
  ...
  for (i=0; i<8; ++i,++ptr)
  {
    ...
    if ((ptr != newPtr) && ((0x02) == ptr->connState) && (ptr->portRx <= (0x3E - 1)))
    {
      if (1 == which)
      {
        if (ptr->portRx > sPersistInfo.curNextLinkPort)
        {
          marker[(0x3E - 1) - ptr->portRx] = 1;
        }
      }
      else if (!memcmp(ptr->peerAddr, newPtr->peerAddr, 4))
      {
          marker[ptr->portRx - 0x20] = 1;
      }
    }
  }
...
uint8_t nwk_isValidReply(mrfiPacket_t *frame, uint8_t tid, uint8_t infoOffset, uint8_t tidOffset)
{
  ...
  if ((*((&((frame)->frame[(((0 + 1) + 4) + 4)]))+(3+0)+infoOffset) & (0x80)))
  {
    if ((*((&((frame)->frame[(((0 + 1) + 4) + 4)]))+(3+0)+tidOffset) == tid) &&
        !memcmp((&((frame)->frame[(0 + 1)])), nwk_getMyAddress(), 4))
    {
      rc = 0;
    }
    else
...
static uint8_t map_lid2idx(linkID_t lid, uint8_t *idx)
{
  ...
  for (i=0; i<(8+1); ++i, ++ptr)
  {
    if (((0x02) == ptr->connState) && (ptr->thisLinkID == lid))
    {
      *idx = i;
      return 1;
    }
...
connInfo_t *nwk_findPeer(addr_t *peerAddr, uint8_t peerPort)
{
  ...
  for (i=0; i<(8+1); ++i, ++ptr)
  {
    if ((0x02) == ptr->connState)
    {
      if (!memcmp(peerAddr, ptr->peerAddr, 4))
      {
...
uint8_t nwk_checkAppMsgTID(appPTid_t lastTID, appPTid_t appMsgTID)
{
  ...
  if (lastTID != appMsgTID)
  {
    ...
    if (appMsgTID > lastTID)
    {
      ...
      if (!(((appMsgTID >= (((appPTid_t)~0) - 2)) && (lastTID <= 2) )))
      {
        rc = 1;
      }
    }
    else
    {
      ...
      if (((lastTID >= (((appPTid_t)~0) - 2)) && (appMsgTID <= 2) ))
      {
        rc = 1;
      }
    }
...
{
#line 1067 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk.c"
  return SMPL_BAD_PARAM;
