#line 1 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk_api.c"
...
#line 41 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk_api.c"
...
#line 42 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk_api.c"
...
#line 43 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk_api.c"
...
#line 44 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk_api.c"
#line 1 "C:\\ti\\msp430\\MSP-EXPCC430_UE_1_00_00_01\\src\\MSP-EXP430F6137Rx_User_Experience\\SimpliciTI\\Components\\simpliciti\\nwk\\nwk_api.h"
...
#line 45 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk_api.c"
#line 1 "C:\\ti\\msp430\\MSP-EXPCC430_UE_1_00_00_01\\src\\MSP-EXP430F6137Rx_User_Experience\\SimpliciTI\\Components\\simpliciti\\nwk\\nwk_frame.h"
...
#line 46 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk_api.c"
#line 1 "C:\\ti\\msp430\\MSP-EXPCC430_UE_1_00_00_01\\src\\MSP-EXP430F6137Rx_User_Experience\\SimpliciTI\\Components\\simpliciti\\nwk\\nwk.h"
...
#line 47 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk_api.c"
#line 1 "C:\\ti\\msp430\\MSP-EXPCC430_UE_1_00_00_01\\src\\MSP-EXP430F6137Rx_User_Experience\\SimpliciTI\\Components\\simpliciti\\nwk\\nwk_app.h"
...
#line 48 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk_api.c"
#line 1 "C:\\ti\\msp430\\MSP-EXPCC430_UE_1_00_00_01\\src\\MSP-EXP430F6137Rx_User_Experience\\SimpliciTI\\Components\\simpliciti\\nwk\\nwk_globals.h"
...
#line 50 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk_api.c"
...
smplStatus_t SMPL_Send(linkID_t lid, uint8_t *msg, uint8_t len)
{
  return SMPL_SendOpt(lid, msg, len, ((txOpt_t)0x00));
}
...
smplStatus_t SMPL_SendOpt(linkID_t lid, uint8_t *msg, uint8_t len, txOpt_t options)
{
  ...
  uint8_t  loc;
   ...
   if (!pCInfo || ((rc=nwk_checkConnInfo(pCInfo, 1)) != SMPL_SUCCESS))
  {
    return rc;
  }
  ...
  memcpy((&((&pFrameInfo->mrfiPkt)->frame[(0 + 1)])), pCInfo->peerAddr, 4);

#line 340 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk_api.c"


  

 
  if (nwk_isSandFClient((&((&pFrameInfo->mrfiPkt)->frame[(0 + 1)])), &loc))
  {
     pFrameInfo->fi_usage = 3;
     return SMPL_SUCCESS;
  }
  else

  {
    rc = nwk_sendFrame(pFrameInfo, 1);
  }
...

  {
    ...
    do { intState = __get_interrupt_state(); __disable_interrupt(); } while (375 == -1);
    if (pCInfo->ackTID)
    {
      pCInfo->ackTID = 0;
      rc = SMPL_NO_ACK;
...
smplStatus_t SMPL_Receive(linkID_t lid, uint8_t *msg, uint8_t *len)
{
  ...
  if (!pCInfo || ((rc=nwk_checkConnInfo(pCInfo, 0)) != SMPL_SUCCESS))
  {
    return rc;
  }
...
#line 506 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk_api.c"
...
smplStatus_t SMPL_Commission(addr_t *peerAddr, uint8_t locPort, uint8_t rmtPort, linkID_t *lid)
{
  ...
  do {
    if (pCInfo)
    {
      ...
      if ((locPort > 0x3E) || (locPort < (0x3E - 1 + 1)))
      {
        continue;
      }

      if ((rmtPort > 0x3E) || (rmtPort < (0x3E - 1 + 1)))
      {
        continue;
      }
      ...
      *lid = pCInfo->thisLinkID;
      ...
      memcpy(pCInfo->peerAddr, peerAddr, 4);
