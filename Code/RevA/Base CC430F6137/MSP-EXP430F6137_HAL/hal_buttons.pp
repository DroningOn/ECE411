#line 1 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/MSP-EXP430F6137_HAL/hal_buttons.c"
...
#line 37 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/MSP-EXP430F6137_HAL/hal_buttons.c"
#line 1 "C:\\ti\\msp430\\MSP-EXPCC430_UE_1_00_00_01\\src\\MSP-EXP430F6137Rx_User_Experience\\MSP-EXP430F6137_HAL\\hal_buttons.h"
...
#line 47 "C:\\ti\\msp430\\MSP-EXPCC430_UE_1_00_00_01\\src\\MSP-EXP430F6137Rx_User_Experience\\MSP-EXP430F6137_HAL\\hal_buttons.h"
...
#line 38 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/MSP-EXP430F6137_HAL/hal_buttons.c"
...
{
  (PAIES_H) &= ~buttonIntEnableMask;
  (PAIFG_H) &= ~buttonIntEnableMask;
  (PAIE_H) |= buttonIntEnableMask;
}
...
void HalButtonsShutDown()
{
  ...
  (PAOUT_H) &= ~(((0x0001)+(0x0002)+(0x0004)+(0x0008)));
  (PADIR_H) |= ((0x0001)+(0x0002)+(0x0004)+(0x0008));             
}
...
void HalButtonsStartWDT()
{
  ...
  SFRIFG1 &= ~(0x0001);
  WDTCTL = (0x5A00) + (1*0x0020u) + (0x0010) + (0x0008) + (5*0x0001u);
  SFRIE1 |= (0x0001);
}
...
{ 
  if (buttonDebounce == 1)   
  {
    buttonsPressed = (PAIFG_H) & ((0x0001)+(0x0002)+(0x0004)+(0x0008));
    buttonDebounce = 2;   
    HalButtonsStartWDT();     
  ...
  {
    buttonsPressed = (PAIFG_L) & ((0x0001)+(0x0002)+(0x0004)+(0x0008));
