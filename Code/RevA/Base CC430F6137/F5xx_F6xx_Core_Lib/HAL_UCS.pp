#line 1 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/F5xx_F6xx_Core_Lib/HAL_UCS.c"
...
#line 46 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/F5xx_F6xx_Core_Lib/HAL_UCS.c"
#line 1 "C:\\ti\\msp430\\MSP-EXPCC430_UE_1_00_00_01\\src\\MSP-EXP430F6137Rx_User_Experience\\F5xx_F6xx_Core_Lib\\HAL_UCS.h"
...
#line 49 "C:\\ti\\msp430\\MSP-EXPCC430_UE_1_00_00_01\\src\\MSP-EXP430F6137Rx_User_Experience\\F5xx_F6xx_Core_Lib\\HAL_UCS.h"
...
#line 50 "C:\\ti\\msp430\\MSP-EXPCC430_UE_1_00_00_01\\src\\MSP-EXP430F6137Rx_User_Experience\\F5xx_F6xx_Core_Lib\\HAL_UCS.h"
...
#line 47 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/F5xx_F6xx_Core_Lib/HAL_UCS.c"
...
void LFXT_Start(uint16_t xtdrive)
{
  ...
  if ((UCSCTL6 & (0x00C0))!= (0x00C0)) { 
    UCSCTL6_L |= (0x0080) + (0x0040); 
  }

  while (SFRIFG1 & (0x0002)) {   
    UCSCTL7 &= ~((0x0001)+(0x0002)+(0x0004)+(0x0008)); 
    SFRIFG1 &= ~(0x0002);        
  }
  
  UCSCTL6 = (UCSCTL6 & ~((0x00C0))) | (xtdrive); 
}
...
{
#line 213 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/F5xx_F6xx_Core_Lib/HAL_UCS.c"
}
...
void Init_FLL(uint16_t fsystem, uint16_t ratio)
{
  ...
  while (d > 512) {
    dco_div_bits = dco_div_bits + (0x1000);  
    d >>= 1;
  }
  ...
  if (mode == 1) {                              		  
    do { UCSCTL4 = (UCSCTL4 & ~((0x0007) + (0x0070))) | ((0x0003) + (0x0030)); } while (286 == -1);       
  }
  else {
    do { UCSCTL4 = (UCSCTL4 & ~((0x0007) + (0x0070))) | ((0x0004) + (0x0040)); } while (289 == -1); 
  }
