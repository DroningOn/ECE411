#line 1 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk_QMgmt.c"
...
#line 41 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk_QMgmt.c"
...
#line 42 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk_QMgmt.c"
...
#line 43 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk_QMgmt.c"
...
#line 44 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk_QMgmt.c"
...
#line 45 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk_QMgmt.c"
#line 1 "C:\\ti\\msp430\\MSP-EXPCC430_UE_1_00_00_01\\src\\MSP-EXP430F6137Rx_User_Experience\\SimpliciTI\\Components\\simpliciti\\nwk\\nwk.h"
...
#line 46 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk_QMgmt.c"
#line 1 "C:\\ti\\msp430\\MSP-EXPCC430_UE_1_00_00_01\\src\\MSP-EXP430F6137Rx_User_Experience\\SimpliciTI\\Components\\simpliciti\\nwk\\nwk_frame.h"
...
#line 47 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk_QMgmt.c"
#line 1 "C:\\ti\\msp430\\MSP-EXPCC430_UE_1_00_00_01\\src\\MSP-EXP430F6137Rx_User_Experience\\SimpliciTI\\Components\\simpliciti\\nwk\\nwk_QMgmt.h"
...
#line 48 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk_QMgmt.c"
...
#line 49 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/SimpliciTI/Components/simpliciti/nwk/nwk_QMgmt.c"
...
static frameInfo_t   sInFrameQ[6];




static frameInfo_t   sOutFrameQ[2];
...
void nwk_QadjustOrder(uint8_t which, uint8_t stamp)
{
  ...
  do { intState = __get_interrupt_state(); __disable_interrupt(); } while (235 == -1);

  for (i=0; i<num; ++i, ++pFI)
  {
    if ((pFI->fi_usage != 0) && (pFI->orderStamp > stamp))
    {
      pFI->orderStamp--;
    }
  }
...
frameInfo_t *nwk_QfindOldest(uint8_t which, rcvContext_t *rcv, uint8_t fi_usage)
{
  ...
  {
    port   = *((&((rcv->t . pkt)->frame[(((0 + 1) + 4) + 4)]))+(3+0)+2);
    pAddr2 = (&((rcv->t . pkt)->frame[((0 + 1) + 4)]));
    pAddr3 = (&((rcv->t . pkt)->frame[(((0 + 1) + 4) + 4)]))+(3+0)+3;
  }
  ...
  uType = (1 == fi_usage) ? 1 : 3;

  for (i=0; i<num; ++i, ++wPtr)
  {

    do { intState = __get_interrupt_state(); __disable_interrupt(); } while (322 == -1);    
    ...
    if (uType == wPtr->fi_usage)
    {
      ...
      if ((((&((&wPtr->mrfiPkt)->frame[(((0 + 1) + 4) + 4)])))[0] & ((0x3F))) == port)
      {
        ...
        if (RCV_APP_LID == rcv->type)
        {
          ...
          {
            pAddr1 = (&((&wPtr->mrfiPkt)->frame[((0 + 1) + 4)]));
          }
        }

        else if (RCV_RAW_POLL_FRAME == rcv->type)
        {
          pAddr1 = (&((&wPtr->mrfiPkt)->frame[(0 + 1)]));
        }


        addr12Compare = memcmp(pAddr1, pAddr2, 4);
        if (  (RCV_NWK_PORT == rcv->type) ||
              (!pAddr3 && !addr12Compare) ||
              (pAddr3 && !memcmp(pAddr3, (&((&wPtr->mrfiPkt)->frame[((0 + 1) + 4)])), 4))
           )
        {
...
{
  return (1 == which) ? sInFrameQ : sOutFrameQ;
}
