#line 1 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/F5xx_F6xx_Core_Lib/HAL_PMM.c"
...
#line 45 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/F5xx_F6xx_Core_Lib/HAL_PMM.c"
#line 1 "C:\\ti\\msp430\\MSP-EXPCC430_UE_1_00_00_01\\src\\MSP-EXP430F6137Rx_User_Experience\\F5xx_F6xx_Core_Lib\\HAL_PMM.h"
...
#line 47 "C:\\ti\\msp430\\MSP-EXPCC430_UE_1_00_00_01\\src\\MSP-EXP430F6137Rx_User_Experience\\F5xx_F6xx_Core_Lib\\HAL_PMM.h"
...
#line 48 "C:\\ti\\msp430\\MSP-EXPCC430_UE_1_00_00_01\\src\\MSP-EXP430F6137Rx_User_Experience\\F5xx_F6xx_Core_Lib\\HAL_PMM.h"



 
#line 64 "C:\\ti\\msp430\\MSP-EXPCC430_UE_1_00_00_01\\src\\MSP-EXP430F6137Rx_User_Experience\\F5xx_F6xx_Core_Lib\\HAL_PMM.h"

#line 74 "C:\\ti\\msp430\\MSP-EXPCC430_UE_1_00_00_01\\src\\MSP-EXP430F6137Rx_User_Experience\\F5xx_F6xx_Core_Lib\\HAL_PMM.h"
...
#line 46 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/F5xx_F6xx_Core_Lib/HAL_PMM.c"
...
#line 70 "C:/ti/msp430/MSP-EXPCC430_UE_1_00_00_01/src/MSP-EXP430F6137Rx_User_Experience/F5xx_F6xx_Core_Lib/HAL_PMM.c"
...
static uint16_t SetVCoreUp(uint8_t level)
{
  ...
  PMMRIE &= ~((0x2000) | (0x1000) | (0x0200) | (0x0100) | (0x0040) |
        (0x0020) | (0x0010) | (0x0004) | (0x0002) | (0x0001) );
  ...
  SVSMHCTL = (0x4000) | (0x0400) | ((0x0001) * level);    

  
  while ((PMMIFG & (0x0010)) == 0); 

  
  PMMIFG &= ~(0x0010);
  
  
  if ((PMMIFG & (0x0020)) == (0x0020)) {      
  	...
  	PMMIFG &= ~((0x0040) | (0x0020) | (0x0010) | (0x0004) | (0x0002) | (0x0001));
  ...
  PMMCTL0_L = (0x0001) * level;

  
  SVSMLCTL = (0x4000) | ((0x0001) * level) | (0x0400) | ((0x0100) * level);
  ...
  SVSMLCTL &= ((0x0100)+(0x0200)+(0x0001)+(0x0002)+(0x0004));

  
  SVSMLCTL_backup &= ~((0x0100)+(0x0200)+(0x0001)+(0x0002)+(0x0004));
  ...
  SVSMHCTL &= ((0x0100)+(0x0200)+(0x0001)+(0x0002)+(0x0004));

  
  SVSMHCTL_backup &= ~((0x0100)+(0x0200)+(0x0001)+(0x0002)+(0x0004));

  
  SVSMHCTL |= SVSMHCTL_backup;
  
  
  while (((PMMIFG & (0x0001)) == 0) && ((PMMIFG & (0x0010)) == 0));
...
static uint16_t SetVCoreDown(uint8_t level)
{
  ...
  PMMIFG &= ~((0x0020) | (0x0010) | (0x0002) | (0x0001));
  
  
  SVSMHCTL = (0x4000) | ((0x0001) * level) | (0x0400) | ((0x0100) * level);
  SVSMLCTL = (0x4000) | ((0x0001) * level) | (0x0400) | ((0x0100) * level);
  
  
  while ((PMMIFG & (0x0010)) == 0 || (PMMIFG & (0x0001)) == 0);
  
  
  PMMIFG &= ~((0x0010) + (0x0001));
